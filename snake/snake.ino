...
int head_x;
int head_y;
int tail[MAX_TAIL_LENGTH];   //pixel number, not coordinates
int len;
int fruit;
int dir = RIGHT;
...
class snake {
    ...
    int tail [MAX_TAIL_LENGTH];       //TODO: add max_length which is given in constructor and is used instead of hard coded 16
    int dir;
...
public:
    ...
    void remove(Adafruit_neoPixel strip){
...
void deleteFruit(){
    strip.setPixelColor(fruit, 0, 0, 0);
}
