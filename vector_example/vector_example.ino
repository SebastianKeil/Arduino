...
void loop()
{
  ...
  int storage_array[ELEMENT_COUNT_MAX];                           //array for vector max size
  Elements vector;                                                //Elements is Vector<int>
  vector.setStorage(storage_array);
  Serial << "vector.max_size(): " << vector.max_size() << endl;   //vector.max_size():  5
  Serial << "vector.size(): " << vector.size() << endl;           //vector.size():      0
  Serial << "vector:" << endl;                          
  Serial << vector << endl;                                       //vector:             []
  delay(DELAY);
    Serial.println("");
  Serial.println("");
  Serial.println("");
  ...
  vector.push_back(10);                                           //vector.push_back(10)
  vector.push_back(8);
  vector.push_back(7);
  ...
  vector2.push_back(2);
  vector2.push_back(4);
  vector2.pop_back();                                               //vector2.pop_back()
